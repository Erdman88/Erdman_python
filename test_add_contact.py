...
class TestAddContact(unittest.TestCase):
    ...
    def create_contact(self, wd, firstname, middlename, lastname, nickname, title, company, address, hometelephone,
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, firstname="firstname", middlename="mname", lastname="lname", nickname="nmane",
